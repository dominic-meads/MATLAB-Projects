...
% 1). If you know what you want to create, like a certain view angle in a
% 3d plot, it is much easier to use a function when creating a plot.
% Functions and handels are easily resuable instead of having to re-create
% them everytime a new figure is launched. 

% 2). When adding 10 realizations of a unformily distrinuted array, the
% result is normally distributed. The graph of the sum can be seen on line
% 198 in my lab code. 
